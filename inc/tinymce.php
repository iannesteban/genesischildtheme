...
**/
  ...
  * @return array
  */
 function ie_mce_editor_buttons( $buttons ) {
 	array_unshift( $buttons, 'styleselect' );
 	return $buttons;
 }
 add_filter( 'mce_buttons_2', 'ie_mce_editor_buttons' );
  ...
  * @return array
  */
 function ie_mce_before_init( $settings ) {
 ...
 add_filter( 'tiny_mce_before_init', 'ie_mce_before_init' );
