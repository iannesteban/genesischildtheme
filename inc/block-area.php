 ...
 * @link https://iannesteban.design/wordpress-gutenberg-block-widget-areas/
 *
...
class ie_Block_Area {
	...
	/**
	 * Class Instance.
	 * @return ie_Block_Area
	 */
	public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof ie_Block_Area ) ) {
			self::$instance = new ie_Block_Area();
 ...
 * @return object
 */
function ie_block_area() {
	return ie_Block_Area::instance();
}
ie_block_area();
