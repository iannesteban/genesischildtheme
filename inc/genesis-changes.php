 ...
 *
 */
function ie_remove_genesis_templates( $page_templates ) {
	unset( $page_templates['page_archive.php'] );
	unset( $page_templates['page_blog.php'] );
	return $page_templates;
}
add_filter( 'theme_page_templates', 'ie_remove_genesis_templates' );

/**
 * Custom search form
 *
 */
function ie_search_form() {
	ob_start();
	get_template_part( 'searchform' );
	return ob_get_clean();
}
add_filter( 'genesis_search_form', 'ie_search_form' );

/**
 * Disable customizer theme settings
 *
 */
function ie_disable_customizer_theme_settings( $config ) {
...
add_filter( 'genesis_customizer_theme_settings_config', 'ie_disable_customizer_theme_settings' );
