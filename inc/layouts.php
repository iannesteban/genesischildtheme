...
// Add new layouts
genesis_register_layout( 'content', [ 'label' => __( 'Content', 'ie_genesis_child' ), ] );
 ...
 *
 */
function ie_editor_layout_style() {
...
add_action( 'enqueue_block_editor_assets', 'ie_editor_layout_style' );

/**
 * Editor layout class
 * @link https://iannesteban.design/change-gutenberg-content-width-to-match-layout/
 *
 * @param string $classes
 * @return string
 */
function ie_editor_layout_class( $classes ) {
...
add_filter( 'admin_body_class', 'ie_editor_layout_class' );
